...
<body class="<?php if ($_POST) echo "pe-none opacity-75"; ?>">
  ...
  <section class="p_banner_ads_strip">
    ...
    <button class="know_more">كيفية المشاركة <img src="./uploads/press-button.png" alt="pressbutton"></button>
    ...
    <div class="custom_modal v_hidden" id="knowMore">
      <div class="content_wrapper">
        ...
        <div class="inner_rwapper">
          ...
          <div class="img_wrp">
            <picture>
            <source media="(max-width:570px)" srcset="./uploads/popup-mob-ar.png">
              <source srcset="./uploads/popup-ar.png" />
              <img src="./uploads/popup-ar.png" alt="image" />
            </picture>
          </div>
        </div>
      </div>
  ...
  <section class="p_ready_to_win_promo">
    <picture>
      <!-- <source media="(min-width:650px)" srcset="img_pink_flowers.jpg"> -->
      <source srcset="./uploads/bottombanner2.jpg" />
      <img src="./uploads/bottombanner2.jpg" alt="image" />
    </picture>
  </section>
  ...
  <section class="p_contact_form_section">
    <div class="fluid-container">
      ...
      <div class="p_form_wrapper">
        ...
        <a href="index.php" class="lang_switch_btn ">English</a>
          <a href="ar.php" class="lang_switch_btn lang_active">العربية</a>
        </div>
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data" id="registrationform">
          ...
          <input type="hidden" id="website_required" name="website_required">
            ...
            <!-- <input type="submit" value="قدِّم الاستمارة" id="submit_btn" name="submit_btn" class="submit_btn"> -->
            <button type="submit" id="submit_btn" name="submit_btn" class="submit_btn">قدِّم الاستمارة <img src="./assets/img/loading.png" alt="loading icon"> </button>
...
$file_extensions    = ['image/jpeg', 'image/pjpeg', 'image/x-png','image/gif','image/heic','image/heif', 'heic'];
...
if(!in_array($extension, $file_extensions)){
  ...
  if ($fileErr === 0) {
    ...
    $checksql = "SELECT first_name FROM nutella_atlantis_campaign WHERE email='$email'";
    ...
    if ($exist != 0) {
      ...
      $sql = "INSERT INTO nutella_atlantis_campaign (	first_name,	last_name ,email,phone,shop_name,country,image_url,lang) VALUES ('$first','$last','$email','$phno','$shopname','$country','$imagePath','ar');";
      $postData = mysqli_query($connect, $sql);
      echo '<script>window.location.href = "success-ar.php"</script>';
    }
  }
}
    }
  ...
  <section class="terms_n_conditions">
    <a href="./assets/img/nutella.pdf" target="_blank" class="anchor_link">الشروط والأحكام</a>
  </section>
